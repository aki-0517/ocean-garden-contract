...
#[test_only]
module nfts::project_nftTests {
    use nfts::project_nft::{Self, ProjectNFT, update_progress, update_description, burn};
    use sui::test_scenario as ts;
    use sui::transfer;
    use std::string;

    #[test]
    fun mint_transfer_update_level() {
        let addr1 = @0xA;
        let addr2 = @0xB;
        // Begin test scenario with addr1 as the creator.
        let scenario = ts::begin(addr1);
        {
            // Mint a new Project NFT.
            project_nft::mint_project_nft(
                b"Bluefin", 
                b"Project Bluefin NFT", 
                b"https://example.com/bluefin", 
                100,                // target_transactions.
                b"bluefin",         // theme_animal id.
                b"Bluefin",         // theme_animal name.
                b"https://example.com/bluefin_image", // theme_animal image URL.
                b"/animals/bluefin1.png",             // theme_animal icon.
                b"/animals/bluefin2.png",             // theme_animal icon2.
                1,                  // initial theme_animal level.
                5,                  // theme_animal max_level.
                ts::ctx(&mut scenario)
            );
        };
        ...
        {
            let nft = ts::take_from_sender<ProjectNFT>(&scenario);
            transfer::public_transfer(nft, addr2);
        };
        // Addr2 updates the description and progress.
        ts::next_tx(&mut scenario, addr2);
        {
            let nft = ts::take_from_sender<ProjectNFT>(&scenario);
            update_description(&mut nft, b"Updated description for Bluefin");
            // Add 20 transactions as an example.
            update_progress(&mut nft, 20, ts::ctx(&mut scenario));
